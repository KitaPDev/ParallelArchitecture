...
void initializeCUDA(int argc, char **argv, int &devID, int &iSizeMultiple, sMatrixSize &matrix_size)
{
    ...
    matrix_size.uiWA = 48 * block_size * iSizeMultiple;
    matrix_size.uiHA = 49 * block_size * iSizeMultiple;
    matrix_size.uiWB = 47 * block_size * iSizeMultiple;
    matrix_size.uiHB = 48 * block_size * iSizeMultiple;
    matrix_size.uiWC = 47 * block_size * iSizeMultiple;
    matrix_size.uiHC = 49 * block_size * iSizeMultiple;
